  ...
  return (
    <article className="guide">
      ...
      <Topic title="Даалгавар өгөх">
        ...
        <p>Даалгавар биш мессеж (жишээ нь группт таныг дурдсан асуулт) ноорог болсон бол <b>🗑 Даалгавар биш</b>-ийг
          дарж хаана.</p>
      </Topic>
      ...
      <Topic title="Группт">
        <p>Группт <code>/task@бот текст</code> эсвэл ботыг дурдсан мессеж бичвэл ноорог таны хувийн чатад
          нээгдэнэ. Хэн нэгэн таныг <code>@username</code>-ээр дурдвал тэр мессеж танд ноорог болж ирнэ; эхлүүлэх
          эсэхийг та шийднэ. Группт юу гарахыг <b>Миний тохиргоо</b>-оос сонгоно.</p>
      </Topic>
