...
| W-4 Worker setup (delivered) | `dispatch worker init`, the worker setup in `dispatch ui`, the worker service, `check`, README, SECURITY.md, ARCHITECTURE.md, ADR 0021 | A live run with two members' computers |
